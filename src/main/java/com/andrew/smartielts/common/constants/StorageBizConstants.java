...
public final class StorageBizConstants {
    ...
    public static final String TARGET_TYPE_LISTENING_QUESTION = "LISTENING_QUESTION";
    public static final String TARGET_TYPE_READING_QUESTION = "READING_QUESTION";
    ...
    public static final String BIZ_PATH_LISTENING_PART_GROUP_IMAGE = "listening-part-group-image";
    public static final String BIZ_PATH_LISTENING_QUESTION_IMAGE = "listening-question-image";
    public static final String BIZ_PATH_READING_PART_GROUP_IMAGE = "reading-part-group-image";
    public static final String BIZ_PATH_READING_QUESTION_IMAGE = "reading-question-image";
