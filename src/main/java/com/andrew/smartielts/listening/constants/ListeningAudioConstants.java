...
public final class ListeningAudioConstants {

    private ListeningAudioConstants() {
    }

    public static final String AUDIO_SCOPE_TEST = "test";
    public static final String AUDIO_SCOPE_PART_GROUP = "part_group";
